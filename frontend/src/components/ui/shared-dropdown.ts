...
export const dropdownContentClasses =
  'relative z-[105] overflow-hidden rounded-xl border border-[color-mix(in_srgb,var(--color-text-primary)_4%,transparent)] bg-surface text-popover-foreground p-1 shadow-md duration-300 ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2'
