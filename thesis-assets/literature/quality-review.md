...
| BIB-09 | 大语言模型安全性综述 | 智能系统学报 | 2025 | DOI: 10.11992/tis.202401006 | A- | 第三、六章 | 纳入复核 | 需后续人工复核后才能进入最终参考文献 |
| BIB-10 | 融合知识图谱的大语言模型研究综述 | 计算机应用研究 | 2025 | DOI: 10.19734/j.issn.1001-3695.2024.12.0532 | A- | 第六章 | 纳入复核 | 需后续人工复核后才能进入最终参考文献 |
| BIB-11 | 针对大语言模型的偏见性研究综述 | 计算机应用研究 | 2024 | DOI: 10.19734/j.issn.1001-3695.2024.02.0020 | B+ | 第二、三、六章 | 纳入复核 | 需后续人工复核后才能进入最终参考文献 |
| BIB-12 | 智慧教育中的大语言模型综述 | 智能系统学报 | 2025 | DOI: 10.11992/tis.202406040 | B+ | 第二章 | 纳入复核 | 由待核验转为可复核候选 |
...
摘要记录：收录若干篇来自 arXiv 的预印本或缺失确切 DOI、出版页码的会议/期刊文章（VN-*）。该部分条目暂不进入正文，待补齐出版信息后再转入高可信候选。
- **不得进入正文。**
- **不得进入正式参考文献。**
- **待补齐出版信息后再转入高可信候选。**
...
摘要记录：低质、幻觉、营销页、新闻报道及其他禁用条目（RJ-*）已剔除，不在本质量复核主表中展开。
- **永久禁用。**
- **不得补救。**
- **不得进入正文。**
- **不得进入正式参考文献。**

## 5.5 未纳入说明（背景参考，不进入正文证据）

- BIB-02 | “GEMINI+互感评估”工作流设计 | 质量评估为 B-，暂不进入主表与正文映射。
