...
| 第 10 页 | 测试验证 | `functional-cases-2026-06.md`、`quality-gates-2026-06-19.md`、`test-evidence-matrix-2026-06.md` | 第五章 | 展示 TC-01 到 TC-12、后端测试、前端 build、audit、BYOK verify、dark verify、Sentrux、JaCoCo report。 | 强调 JaCoCo report-only |
