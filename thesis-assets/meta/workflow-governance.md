...
| 外部研究摘要 | evidence/research-notes/ | GPT/Gemini Deep Research | 存在明确引用出处 | 查阅源出处避免幻觉 |
...
| --- | --- | --- | --- | --- | --- |
| GPT Deep Research | 外部文献综述、官方文档核验、竞品调研、AI/教育补充研究 | 挖掘或替代本地私有代码实现 | 研究 Prompt | evidence/research-notes/ | 人工查证、确认无幻觉 |
| Gemini Deep Research | 交叉验证、不同检索生态补充 | 替代事实逻辑 | 研究 Prompt | evidence/research-notes/ | 同上 |
...
5. 研究报告必须先进入 evidence/research-notes/。
...
build-docx.ps1 只生成 current/thesis-working-draft.docx 工作稿。
...
| --- | --- | --- | --- | --- |
| DOCX 工作稿构建 | current/thesis-working-draft.docx | 是 (build-docx.ps1) | 否 | 开发者自测 |
...
thesis-assets/evidence/research-notes/
...
不得以 current/thesis-working-draft.docx 或 gzu-thesis-template.docx 作为正文修改源。
