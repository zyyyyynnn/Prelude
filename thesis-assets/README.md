...
| Bug 证据 | `evidence/bug-evidence/package-2026-04-24.md`、`evidence/bug-evidence/` |
| 文献工作库 | `literature/references-draft.bib` |
| 文献质量与映射 | `literature/quality-review.md`、`literature/evidence-map.md` |
...
| 答辩材料 | `defense/package-2026-04-25.md`、`defense/slide-map.md`、`defense/script.md` |
