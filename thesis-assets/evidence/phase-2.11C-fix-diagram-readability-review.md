...
- **新版 viewBox 比例核验**：
  | 图 | viewBox | 宽高比 | 是否通过 | 说明 |
  | :--- | :--- | :---: | :---: | :--- |
  | **图3.1** | 1172.67 x 928.95 | 1.26 | 是 | 满足 1.2 ~ 1.8，字体渲染优良，无截断 |
  | **图3.2** | 838.34 x 807.00 | 1.04 | 是 | 满足 1.0 ~ 1.6，表格边距自然，无截断 |
  | **图3.3** | 1336.55 x 851.50 | 1.57 | 是 | 满足 1.3 ~ 2.0，文字排版清晰，无截断 |
  | **图4.x** | 774.00 x 789.00 | 0.98 | 是 | 满足 0.9 ~ 1.5，左右分支间距拉宽，无截断 |

- **人工打开检查结果**：
  - 各图文字完全显式完整，左右均有充足空间，尾部没有任何截断；
  - 节点间距与容器排版非常舒适，没有互相贴近或遮挡；
  - 比例全部落在验收区间内。
