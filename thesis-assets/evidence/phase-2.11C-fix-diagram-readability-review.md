...
- **新版 viewBox 比例核验**：
  | 图 | viewBox | 宽高比 | 是否通过 | 说明 |
  | :--- | :--- | :---: | :---: | :--- |
  | **图3.1** | 1207.67 x 868.95 | 1.39 | 是 | 满足 1.2 ~ 1.8，字号比例与间距良好 |
  | **图3.2** | 838.34 x 807.00 | 1.04 | 是 | 满足 1.0 ~ 1.6，孤立配置节点位置自然 |
  | **图3.3** | 1336.55 x 851.50 | 1.57 | 是 | 满足 1.3 ~ 2.0，子图容器大小紧凑 |
  | **图4.x** | 713.39 x 666.00 | 1.07 | 是 | 满足 0.9 ~ 1.5，连线清晰无长距离回线 |

- **人工打开检查结果**：
  - 文字完全无任何截断、溢出或贴边；
  - 节点垂直与水平间距舒适，比例极佳；
  - 无明显跨越半图的冗长边；
  - 图3.2 标题与实际图例口径一致，图4.x 链条非常紧凑。
