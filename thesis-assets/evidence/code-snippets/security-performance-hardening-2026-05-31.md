...
## [DEPRECATED] 证据 4：LLM 结构化提取的柔性降级（已被证据 9 Structured Output 替代）

> **状态：已弃用。** 该证据仅用于说明旧版正则评分提取方案的历史演进，不得作为当前系统实现依据。当前有效实现以 `structured-output-resilience-2026-06-02.md` 中的证据 9 为准。
