...
import com.interview.identity.api.UserController;
...
class UserControllerWebMvcTest {
    ...
    void setUp() {
        ...
        mockMvc = MockMvcBuilders.standaloneSetup(new UserController(llmConfigPort, userProfileService))
    ...
    void updateLlmConfigValidatesBodyAndPassesRequestToService() throws Exception {
        ...
        verify(llmConfigPort).saveCurrentUserConfig(captor.capture());
    ...
    void testLlmConfigAllowsEmptyBodyAndPassesNullRequest() throws Exception {
        ...
        verify(llmConfigPort).testConfig(isNull());
    }
