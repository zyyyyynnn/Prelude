...
public class AnthropicProvider implements LlmProvider {
    ...
    private String invoke(LlmInvocation invocation, boolean stream, Consumer<String> onDelta) {
        ...
        Object dialogMessages = invocation.attachments().isEmpty()
            ? allMessages.stream().filter(m -> !"system".equals(m.get("role"))).toList()
            : LlmMultimodalMessages.anthropic(allMessages, invocation.attachments());
